//this file well just shows you a large number of functions you can use 
...
client.on('loading_screen', (percent, message)const { Client, Location, Poll, List, Buttons, LocalAuth } = require('./index');
